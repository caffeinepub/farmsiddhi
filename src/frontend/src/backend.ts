...
import type { Address as _Address, Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, ProductDetail as _ProductDetail, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllMandiPrices(): Promise<Array<MandiPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMandiPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMandiPricesByCategory(arg0: string): Promise<Array<MandiPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMandiPricesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMandiPricesByCommodity(arg0: string): Promise<Array<MandiPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMandiPricesByCommodity(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMandiPricesByMarket(arg0: string): Promise<Array<MandiPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMandiPricesByMarket(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMandiPricesByState(arg0: string): Promise<Array<MandiPrice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMandiPricesByState(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedMandiPrices(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedMandiPrices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProductDetail]): ProductDetail | null {
    return value.length === 0 ? null : value[0];
}
