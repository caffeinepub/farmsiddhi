...
import { FileCheck, Globe, Package, ShieldCheck, Truck } from "lucide-react";
      ...
      <section className="bg-muted/30 py-16">
        <div className="section-container text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Comprehensive export solutions ensuring quality, compliance, and
            reliable delivery to global markets
          </p>
        </div>
      </section>
      ...
      <section className="section-container section-padding">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground text-center mb-8 leading-relaxed">
            FarmSiddhi exports premium Indian agricultural products to markets
            across the globe. Our established relationships with international
            buyers and deep understanding of regional requirements enable smooth
        ...
        <div className="section-container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Partner with us for reliable, compliant, and efficient export
              solutions. Our team is ready to help you access global markets
              with confidence.
            </p>
          </div>
        </div>
