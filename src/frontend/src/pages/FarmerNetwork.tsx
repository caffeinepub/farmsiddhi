...
import { Handshake, DollarSign, Network, Award, Smartphone } from 'lucide-react';
    ...
    <div>
      ...
      <section className="bg-muted/30 py-16">
        <div className="section-container text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Farmer Network</h1>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Empowering farmers through direct market access, fair pricing, and digital enablement
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3 text-lg">Market Access</h3>
                <p className="text-muted-foreground">
                  Connect with bulk buyers, retailers, and international importers without
                  intermediaries
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3 text-lg">Better Returns</h3>
                <p className="text-muted-foreground">
                  Receive fair market prices with transparent pricing and timely payments
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3 text-lg">Quality Support</h3>
                <p className="text-muted-foreground">
                  Access training and resources to meet international quality standards
                </p>
              </div>
              <div className="bg-card p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3 text-lg">Digital Tools</h3>
                <p className="text-muted-foreground">
                  Use our platform for market insights, order management, and payment tracking
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="section-container section-padding">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Become part of a growing community of farmers accessing global markets and receiving fair
            value for their produce. Contact us to learn more about partnership opportunities.
          </p>
        </div>
      </section>
    </div>
